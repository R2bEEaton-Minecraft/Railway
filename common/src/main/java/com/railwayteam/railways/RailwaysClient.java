...
public class RailwaysClient {
  ...
  public static void init() {
    ...
    // The 1.21.8 Create Fly TrackMaterial factory no longer carries the old
    // model suppliers used by Railways. Ensure every custom material has a
    // valid holder before curved-track block entities can be rendered.
    TrackMaterial.ALL.values().forEach(material -> {
      if (material.getModelHolder() == null) {
